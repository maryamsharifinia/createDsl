...
public class ExampleDSLParser extends Parser {
	...
	public static final int
		...
		TYPE=39, ROWS=40, ROW=41, CONDITION=42, VALUES=43, IN=44, RESULT=45, SEPARATE=46, 
		FILES=47, TO=48, WITH=49, AND=50, BY=51, FROM=52, WHERE=53, ON=54, OF=55, 
		FOR=56, AS=57, SAVE=58, BASED=59, SUM=60, NEW=61, MULTIPLYING=62, DUPLICATE=63, 
		NUMBER=64, STRING=65, ID=66, WS=67, RESULTS=68;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'rows'", "'row'", "'condition'", "'values'", "'in'", "'result'", "'separate'", 
			"'files'", "'to'", "'with'", "'and'", "'by'", "'from'", "'where'", "'on'", 
			"'of'", "'for'", "'as'", "'save'", "'based'", "'sum'", "'new'", "'multiplying'", 
			"'duplicate'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CONDITION", "VALUES", "IN", "RESULT", "SEPARATE", "FILES", "TO", "WITH", 
			"AND", "BY", "FROM", "WHERE", "ON", "OF", "FOR", "AS", "SAVE", "BASED", 
			"SUM", "NEW", "MULTIPLYING", "DUPLICATE", "NUMBER", "STRING", "ID", "WS", 
			"RESULTS"
		};
	}
